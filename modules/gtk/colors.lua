...
function M.make_colors(theme)
	...
	return {
		...
		grey_050 = theme.ui.background:shade(0.05),
		grey_100 = theme.ui.background:shade(0.1),
		grey_150 = theme.ui.background:shade(0.15),
		grey_200 = theme.ui.background:shade(0.2),
		grey_250 = theme.ui.background:shade(0.25),
		grey_300 = theme.ui.background:shade(0.3),
		grey_350 = theme.ui.background:shade(0.35),
		grey_400 = theme.ui.background:shade(0.4),
		grey_450 = theme.ui.background:shade(0.45),
		grey_500 = theme.ui.background:shade(0.5),
		grey_550 = theme.ui.background:shade(0.55),
		grey_600 = theme.ui.background:shade(0.6),
		grey_650 = theme.ui.background:shade(0.65),
		grey_700 = theme.ui.background:shade(0.7),
		grey_750 = theme.ui.background:shade(0.75),
		grey_800 = theme.ui.background:shade(0.8),
		grey_850 = theme.ui.background:shade(0.85),
